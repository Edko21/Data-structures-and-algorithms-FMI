...
// Write a function that takes a string representing a mathematical expression
// written in Reverse Polish Notation (RPN). The function must compute the value
// of the expression or report an error if the expression is invalid.
