...
template <class T>
Vector<T>::Vector(size_t count): _data(new T[count]()), _size(count), _capacity(count){}

template <class T>
Vector<T>::Vector(size_t count, const T& initial): _data(new T[count]), _size(count), _capacity(count){
